...
def process_file(filepath):
    ...
    # force update if content changed OR if we just want to ensure
    # Let's check if we actually replaced last_ingested
...
files_to_process = [
    r"frameworks\alcoa-plus\FWK-D-001-alcoa.md",
    r"frameworks\monitoreo-control\MDL-023-time-series-forecasting.md"
]
