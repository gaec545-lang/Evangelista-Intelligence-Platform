---
name: claudeflow-spec-validate
description: >
  Analyze a specification document to determine if it has enough detail for autonomous implementation. Use to validate specs before decomposition. Triggered when you see or use: "/spec:validate", "spec:validate", "spec-validate".
---
