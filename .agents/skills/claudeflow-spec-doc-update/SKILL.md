---
name: claudeflow-spec-doc-update
description: >
  Review documentation for updates needed after implementation Triggered when you see or use: "/spec:doc-update", "spec:doc-update".
---
