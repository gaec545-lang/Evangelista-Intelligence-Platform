---
name: claudeflow-spec-decompose
description: >
  Break down a validated specification into actionable implementation tasks Triggered when you see or use: "/spec:decompose", "spec:decompose".
---
