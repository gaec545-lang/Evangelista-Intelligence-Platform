-- Migración 009, 010, 011, 012 consolidada
-- Evangelista Intelligence Platform — Extensión: Gestión de Proyectos Multi-Equipo

-- ============================================================================
-- 009 — Tabla project_workstreams
-- ============================================================================
...
CREATE INDEX idx_workstream_tasks_status ON workstream_tasks(status);
