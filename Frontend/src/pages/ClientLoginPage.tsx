    ...
    >
      ...
      <div className="absolute inset-0 z-0 opacity-100">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
          <rect width="100" height="100" fill="#141410" />
          {/* HIGH VISIBILITY LINES */}
          <path d="M-10,20 C30,80 70,20 110,80" stroke="var(--eva-gold)" strokeWidth="2" fill="none" />
          <path d="M-10,50 C30,10 70,90 110,50" stroke="var(--eva-gold)" strokeWidth="1" fill="none" />
          <path d="M50,-10 C10,30 90,70 50,110" stroke="var(--eva-olive)" strokeWidth="2.5" fill="none" />
          <path d="M20,-10 C80,40 20,60 80,110" stroke="var(--eva-olive)" strokeWidth="1" fill="none" />
          <path d="M0,0 L100,100" stroke="var(--eva-gold)" strokeWidth="0.2" opacity="0.3" fill="none" />
          <path d="M100,0 L0,100" stroke="var(--eva-olive)" strokeWidth="0.2" opacity="0.3" fill="none" />
        </svg>
      </div>
      ...
      <div className="relative z-10 flex h-full w-full">
        ...
        <div className="hidden lg:flex w-1/2 h-full flex-col p-8">
          <div className="relative flex-1 rounded-[3rem] border border-[var(--eva-border)] bg-[#1e1e1a]/40 backdrop-blur-xl flex flex-col justify-between p-12 overflow-hidden shadow-2xl">
            {/* Logo */}
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-mono text-[10px] uppercase tracking-widest text-[var(--eva-gold)]">Portal de Clientes</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              <h1 className="font-brand italic text-[42px] text-white text-center leading-tight">
                ...
                sobre tu <br />
                <span className="text-[var(--eva-gold)] not-italic font-bold">estrategia.</span>
              </h1>
              <div className="w-16 h-[2px] mt-8 bg-[var(--eva-gold)]/30" />
            </div>
        ...
        <div className="flex-1 lg:w-1/2 h-full flex flex-col justify-center px-8 md:px-24 relative">
          ...
          <button 
            onClick={() => navigate('/')}
            className="absolute top-10 left-10 md:left-24 flex items-center gap-2 text-[var(--eva-txt-secondary)] hover:text-white transition-colors text-[13px]"
          >
            <ArrowLeft size={16} />
            <span>Volver al acceso principal</span>
          </button>

          <div className="max-w-md w-full mx-auto bg-[#1e1e1a]/85 backdrop-blur-2xl p-10 rounded-[2.5rem] border border-[var(--eva-border)] shadow-2xl">
            <header className="mb-10">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-6 h-[2px] bg-[var(--eva-gold)]" />
                <span className="font-mono text-[11px] uppercase tracking-widest text-[var(--eva-gold)] font-bold">Portal VIP</span>
              </div>
